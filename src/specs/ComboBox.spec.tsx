...
import ComboBox, {ButtonInfo, ComboBoxItem} from "misevi/form/ComboBox"
...
xdescribe("ComboBox should", () => {
	...
	const getButtonsContainer = async () =>
		await getAncestorOf(queryClearButton(), {tag: "div"})
	const getComboBoxContainer = async () =>
		await getAncestorOf(await getSelect(), {tag: "div"})
	const getSelect = async () =>
		await findChildOf(screen, {tag: "select"}) as HTMLSelectElement
